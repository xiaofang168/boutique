 ...
 * @version: V1.0
 */
public class AbstractBoutiqueApplicationTest extends TapestryTest{

	
	public AbstractBoutiqueApplicationTest(TapestryTester tester) {
		super(tester);
